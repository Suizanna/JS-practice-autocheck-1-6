...
//     // const { brand, model, price } = config; // деструктуризируем
//     this.brand = brand;
//     this.model = model;
//     this.price = price;
...
// // с помощью prototype добавляем метод sayHi.
// // prototype - это общее хранилище методов.
...
//  // const myCar = new Car('Audi',"Q3", 35000); // без деструктуризации
//   // console.log(myCar);
//   // const myCar2 = new Car();
//   // console.log(myCar2);

// const myCar = new Car({  // с деструктуризацией
//   brand: 'Audi',
//    model: 'Q3',
//    price: 35000,
//  });
